...
let button5;
 ...
 function setup() {
  ...
  button5.mousePressed(() => {
   // Switch back to the menu screen when clicked
    ...
    // hide the button in the beginning//didnt work
    button.hide();
 ...
 function southScene() {
  ...
  fill(0);  
  text("Beach", 250, 300, 150, 40);  
  
  // Draw the Desert rectangle 
  fill(243, 228, 22);
  rect(450, 300, 150, 40, 20);  
  
  fill(0);  
  text("Desert", 450, 300, 150, 40);  
 ...
 function helpScreen() {
  ...
  let textContent = "Because I was told for a midterm grade. But also because I knew I could put what was in my head into a code and game. I tried my best and put myself and body through it.";
  let textContent1 = "I did a lot of my work in p5 in the beginning because of tech issues but it actually helped with my learning progression. I was able to have multiple tabs to represent each page and then connect them all in one big code.";
  let textContent2 = "The idea is to be like a travel through an unknown nation that leads you to various places that have challenges. Inspiration from Bandersnatch and choose your own adventures Each scene in theory will be art and puzzles to next scene.";
