...
fill(0);
   textSize(32);
   textAlign(CENTER, CENTER);
   text("Music ON/OFF", width / 6, height / 6);
 ...
 function helpScreen() {
  ...
  let textContent = "I wanted to make my midterm game more in depth and more interactive. I already did so much that i couldn't think of what to add at first besides mini games. I decided to add more of a storyline that the user can follow and get lost in";
  let textContent1 = "I spent a lot of time making sure my codes were connected even going as deep as changing the colors of each scene to a set theme to representing levels";
